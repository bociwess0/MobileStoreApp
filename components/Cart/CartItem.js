        ...
        <View style={styles.productItemWrapper}>
            ...
            <View style={styles.textWrapper}>
                ...
                <View style={styles.brandAndViewMore}>
                    ...
                    <View style={{backgroundColor: `${props.item.item.selectedColor}`, width: 20, height: 20, borderRadius: 50}}></View>
                </View>
                ...
                <Pressable style={({pressed}) => [styles.removeFromCartButton, {opacity: pressed ? 0.7 : 1}]} onPress={removeFromCartHandler}>
